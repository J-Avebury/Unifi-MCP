...
pub(crate) const COMPATIBILITY_TOOLS: &[ToolSpec] = &[
    ...
    write(
        ...
        "Create OON Policy",
        "security",
        "v2:object-oriented-network-config",
        CompatibilityMethod::Post,
        None,
        false,
        false,
    ...
    write(
        ...
        "Delete OON Policy",
        "security",
        "v2:object-oriented-network-config/{id}",
        CompatibilityMethod::Delete,
        Some("policy_id"),
        true,
        true,
